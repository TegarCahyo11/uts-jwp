...
public class TeacherController {
    ...
    public ResponseEntity<Teacher> findTeacher(@PathVariable String nip) {
    ...
    public String updateTeachers(@PathVariable String nip,
                                Teacher teacher,
	...
	@GetMapping("/edit/{nip}")
    public String showUpdateForm(@PathVariable String nip, Model model) {
    ...
    public String deleteTeacher(@PathVariable String nip) {
